...
local function msg_all(message)
...
local function find_targeting(entity)
    local range = global.autodeconstruct_max_radius
...
local function find_drills(entity)
    ...
    local top_left = {x = position.x - global.autodeconstruct_max_radius, y = position.y - global.autodeconstruct_max_radius}
    local bottom_right = {x = position.x + global.autodeconstruct_max_radius, y = position.y + global.autodeconstruct_max_radius}
...
function autodeconstruct.init_globals()
    global.autodeconstruct_max_radius = 0.99
...
function autodeconstruct.check_drill(drill)
    ...
    if mining_drill_radius > global.autodeconstruct_max_radius then
        global.autodeconstruct_max_radius = mining_drill_radius
    end
...
function autodeconstruct.on_built_entity(event)
    ...
    if event.created_entity.prototype.mining_drill_radius > global.autodeconstruct_max_radius then
        global.autodeconstruct_max_radius = event.created_entity.prototype.mining_drill_radius
        if global.debug then msg_all({"autodeconstruct-debug", "on_built_entity", "global.autodeconstruct_max_radius updated to " .. global.autodeconstruct_max_radius}) end
    end
end
